export const Footer = () => {
  return (
    <div className="bg-sky-200">
      ...
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-2 text-base font-semibold">
          ...
          <div className="flex">
            ...
            <a
              href="firozhossain8076@gmail.com"
              aria-label="Our email"
              title="Our email"
              className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800"
            >
              firozhossain8076@gmail.com
            </a>
          </div>
          <div className="flex">
      ...
      <div className="flex flex-col-reverse text-lg font-bold  justify-between pt-5 pb-10 border-t lg:flex-row">
        <p className="text-lg text-gray-900">
          © Copyright 2023 All reserved @Md Firoz Hossain
        </p>
        <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
          <li>
            <a
              href="/"
              className="text-base text-gray-900 transition-colors duration-300 hover:text-deep-purple-accent-400"
            >
              F.A.Q
            </a>
          </li>
